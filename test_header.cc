...
TEST_F(HeaderTest, setHeader) {
  ...
  std::string bit_string = "00000000000000000000000000000011000000000000000000000000000000110000000000000000000000000000001100000000000000110000001100011111";
